...
| Skill                                                       | Description                                                                                                                                                                                                                                                |
| ----------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [ai-epistemic-discovery](ai-epistemic-discovery/SKILL.md)   | Discover and rank public GitHub users for manual longitudinal review of AI-mediated epistemic-world formation using explainable, non-clinical signals.                                                                                                     |
