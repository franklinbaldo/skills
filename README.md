...
| [okf-agent-skills](okf-agent-skills/SKILL.md) | Inspect and govern Agent Skills through a derived OKF relational/graph view, keeping the integration skill-first and `okf-parser` domain-neutral. |
