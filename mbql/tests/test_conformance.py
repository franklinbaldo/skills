...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("SELECT stddev(total) FROM orders", "stddev_sample", Status.UNSUPPORTED),
        ("SELECT stddev_samp(total) FROM orders", "stddev_sample", Status.UNSUPPORTED),
        ("SELECT stddev_pop(total) FROM orders", "stddev_population", Status.SUPPORTED),
        ("SELECT variance(total) FROM orders", "variance_sample", Status.UNSUPPORTED),
        ("SELECT var_pop(total) FROM orders", "variance_population", Status.SUPPORTED),
