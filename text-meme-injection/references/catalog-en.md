...
Reference catalog for the `text-meme-injection` skill. The stability
tiers (stable / in-rotation / risky), the cut test, and all core
principles defined in SKILL.md apply to every entry here.
